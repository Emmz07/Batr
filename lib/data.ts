...
export const data: Record<string, AnimeSceneEntry[]> = {
  demonSlayer: [
    {
      src: demonSlayer1 as unknown as string,
      offsetX: -460,
      offsetY: -190,
      rotate: -8,
    },
    {
      src: demonSlayer2 as unknown as string,
      offsetX: -10,
      offsetY: -300,
      rotate: 2,
    },
    {
      src: demonSlayer3 as unknown as string,
      offsetX: 430,
      offsetY: -100,
      rotate: -4,
    },
  ...
  silentVoice: [
    {
      src: silentVoice1 as unknown as string,
      offsetX: -500,
      offsetY: -100,
      rotate: 3,
    },
    {
      src: silentVoice2 as unknown as string,
      offsetX: -10,
      offsetY: -270,
      rotate: -4,
    },
    {
      src: silentVoice3 as unknown as string,
      offsetX: 400,
      offsetY: -70,
      rotate: -2,
    },
  ...
  attackOnTitan: [
    {
      src: attackOnTitan1 as unknown as string,
      offsetX: -420,
      offsetY: -110,
      rotate: -5,
    },
    {
      src: attackOnTitan2 as unknown as string,
      offsetX: 50,
      offsetY: -200,
      rotate: 4,
    },
    {
      src: attackOnTitan3 as unknown as string,
      offsetX: 450,
      offsetY: 20,
      rotate: 10,
    },
  ...
  spiritedAway: [
    {
      src: spiritedAway1 as unknown as string,
      offsetX: -500,
      offsetY: -10,
      rotate: -5,
    },
    {
      src: spiritedAway2 as unknown as string,
      offsetX: -10,
      offsetY: -100,
      rotate: 3,
    },
    {
      src: spiritedAway3 as unknown as string,
      offsetX: 370,
      offsetY: 200,
      rotate: -7,
    },
  ...
  bunnyGirl: [
    {
      src: bunnyGirl1 as unknown as string,
      offsetX: -450,
      offsetY: 100,
      rotate: -2,
    },
    {
      src: bunnyGirl2 as unknown as string,
      offsetX: -100,
      offsetY: -20,
      rotate: -3,
    },
    {
      src: bunnyGirl3 as unknown as string,
      offsetX: 350,
      offsetY: 250,
      rotate: 2,
    },
